...
const Struk = () => {
  ...
  const handleDownloadPDF = () => {
    ...
    // Tambah mode print agar styling berubah
    ...
    setTimeout(() => {
      html2pdf()
        .set({
          margin: 5,
          filename: `Struk-${pemesanan.nama_pelanggan}.pdf`,
          image: { type: 'jpeg', quality: 1 },
          html2canvas: { scale: 2, useCORS: true },
          jsPDF: { unit: 'mm', format: [80, 200], orientation: 'portrait' }, // ukuran thermal
        })
        .from(content)
        .save()
        .then(() => {
          document.body.classList.remove(styles.printMode); // balikan ke mode web
        });
    }, 200);
  };
