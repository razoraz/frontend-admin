...
function GrafikReservasi() {
  ...
  // Set page title
  useEffect(() => {
    document.title = 'Grafik Reservasi - Basecamp Kopi';
  }, []);
  ...
  return (
    <>
      <HeaderPage title="GRAFIK RESERVASI" />
      ...
      <main className={styles.container}>
        ...
        <div className={styles.filterBox}>
          ...
          <div className={styles.actionBar}>
            <button className={styles.tabelBtn} onClick={() => navigate('/reservasi')}>
              <i className="fas fa-chart-bar"></i> Lihat Tabel Reservasi
            </button>
          </div>
        </div>
            ...
            <Bar
              ...
              options={{
                ...
                plugins: {
                  ...
                  title: {
                    display: true,
                    text: mode === 'harian' ? 'Data Reservasi Per Hari' : mode === 'bulanan' ? 'Data Reservasi Per Bulan' : 'Data Reservasi Per Tahun',
                    font: { size: 18 },
                  },
                },
                scales: {
...
export default GrafikReservasi;
